...
window.addEventListener('load', (event) => {
    ...
    <img src="${listTrang[0].anh}" width="250px" />
</div>
<div class="Describe">
    <h1 class="Name">${listTrang[0].tenphim}</h1>
    <br>
    <div class="wa">
        <div class="wa1">
            <label>Đạo Diễn: </label>
            <div class="std">${listTrang[0].daodien}</div>
        </div>
        <div class="wa1">
            <label>Diễn viên: </label>
            <div class="std">
            ${listTrang[0].dienvien}
            </div>
        </div>
        <div class="wa1">
            <label>Thể loại: </label>
            <div class="std">${listTrang[0].theloai}</div>
        </div>

        <div class="wa1">
            <label>Thời lượng: </label>
            <div class="std">${listTrang[0].thoiluong}</div>
        </div>
        <div class="wa1">
            <label>Ngôn ngữ: </label>
            <div class="std">${listTrang[0].ngonngu}</div>
        </div>
        <div class="wa1">
            <label>Rated: </label>
            <div class="std_Rated">
...
nammm.innerHTML=`>${listTrang[0].mota}
`;
loadCa(listTrang[0].tenphim);
 });
