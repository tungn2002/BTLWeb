...
window.addEventListener('load', (event) => {
    ...
    <img src="${listTrang[1].anh}" width="250px" />
</div>
<div class="Describe">
    <h1 class="Name">${listTrang[1].tenphim}</h1>
    <br>
    <div class="wa">
        <div class="wa1">
            <label>Đạo Diễn: </label>
            <div class="std">${listTrang[1].daodien}</div>
        </div>
        <div class="wa1">
            <label>Diễn viên: </label>
            <div class="std">
            ${listTrang[1].dienvien}
            </div>
        </div>
        <div class="wa1">
            <label>Thể loại: </label>
            <div class="std">${listTrang[1].theloai}</div>
        </div>

        <div class="wa1">
            <label>Thời lượng: </label>
            <div class="std">${listTrang[1].thoiluong}</div>
        </div>
        <div class="wa1">
            <label>Ngôn ngữ: </label>
            <div class="std">${listTrang[1].ngonngu}</div>
        </div>
        <div class="wa1">
            <label>Rated: </label>
            <div class="std_Rated">
...
nammm.innerHTML=`${listTrang[1].mota}
`;
loadCa(listTrang[1].tenphim);
 });
