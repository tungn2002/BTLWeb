...
window.addEventListener('load', (event) => {
    ...
    <img src="${listTrang[2].anh}" width="250px" />
</div>
<div class="Describe">
    <h1 class="Name">${listTrang[2].tenphim}</h1>
    <br>
    <div class="wa">
        <div class="wa1">
            <label>Đạo Diễn: </label>
            <div class="std">${listTrang[2].daodien}</div>
        </div>
        <div class="wa1">
            <label>Diễn viên: </label>
            <div class="std">
            ${listTrang[2].dienvien}
            </div>
        </div>
        <div class="wa1">
            <label>Thể loại: </label>
            <div class="std">${listTrang[2].theloai}</div>
        </div>

        <div class="wa1">
            <label>Thời lượng: </label>
            <div class="std">${listTrang[2].thoiluong}</div>
        </div>
        <div class="wa1">
            <label>Ngôn ngữ: </label>
            <div class="std">${listTrang[2].ngonngu}</div>
        </div>
        <div class="wa1">
            <label>Rated: </label>
            <div class="std_Rated">
...
nammm.innerHTML=`>${listTrang[2].mota}
`;
loadCa(listTrang[2].tenphim);
 });
